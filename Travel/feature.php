...
<body class="body1">
    <div class="box">
        ...
        <div class="box-content-right">
            ...
            <button style="margin-left: 400px; margin-top: 100px;" type="button" class="btn btn-primary " data-toggle="modal" data-target="#exampleModalLong">
            Insert Feature
            </button>
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Fetaure</h5>
                ...
                <div class="modal-body">
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" name="txt_dis" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="txt_title_detail" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="">photo</label>
                            <input type="file" name="txt_photo" class="form-control">
                        </div>
                        <input type="submit" value="Insert" name="btn-feature" class="btn btn-outline-info">
                    </form>
                </div>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><?=$row['discount']?></td>
                            <td><?=$row['title']?></td>
                            <td><p class="title"><?=$row['title_detail']?></p></td>
                            <td><img style="width: 50px; heigth= 50px;" src="../feature_image/<?=$row['photo']?>"></td>
                            <td>
                                <button class="btn btn-info" type="submit" data-toggle="modal" data-target="#updateModel<?=$row['id']?>">Edit</button>
                                <button class="btn btn-danger" type="submit" data-toggle="modal" data-target="#deleteModel<?=$row['id']?>">Delete</button>
                            </td>
                        </tr>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title text-dark" id="exampleModalLongTitle">Update feature</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body text-dark">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <input type="submit" value="No" class="btn btn-outline-danger">
                                    <input type="submit" value="Update" name="btn_update" class="btn btn-outline-success">
                                </div>
                            </form>
                        </div>
                        </div>
                    ...
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-body text-dark">
                            <form action="" method="post" enctype="multipart/form-data">
                                <p class="text-dark">Do you want to delete it?</p>
                                <div class="form-group">
                                    <input type="hidden" name="txt_id" value="<?= $row['id'] ?>">
                                    <input type="submit" value="Cancel" class="btn btn-outline-warning">
                                    <input type="submit" value="Delete" name="btn_delete" class="btn btn-outline-danger">
                                </div>
                            </form>
                        </div>
                        </div>
