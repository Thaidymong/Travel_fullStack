        ...
        <div class="box-content-right">
                ...
                <div class="modal-body">
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" name="txt_content" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="">title detail</label>
                            <input type="text" name="txt_detail" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="">photo</label>
                            <input type="file" name="txt_photo" class="form-control">
                        </div>
                        <input type="submit" value="Insert" name="btn-about" class="btn btn-outline-info">
                    </form>
                </div>
                </div>
            </div>
            ...
            <table id="myTable" class="table w-100 text-white" >
                ...
                <tbody>
                    ...
                    <?php
                        $sql_about  = "SELECT * FROM `tb_about`";
                    ...
                    <tr>
                        ...
                        <td><img style="width: 30px;height: 30px;"src="../about_image/<?=$row['photo']?>" alt=""></td>
                        <td>
                    ...
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <input type="submit" value="Update" name="btn-about-update" class="btn btn-outline-info">
                            </form>
                        </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-body text-dark">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group text-dark">
                                    ...
                                    <input type="submit" value="Delete" name="btn-about-delete" class="btn btn-outline-success">
                                </div>
