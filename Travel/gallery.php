    ...
    <div class="box">
        ...
        <div class="box-content-right">
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <input type="submit" value="Insert" name="btn-gallery" class="btn btn-outline-info">
                    </form>
                </div>
                </div>
            </div>
            ...
            <table id="myTable" class="table w-100 text-white" >
                ...
                <tbody>
                   <?php
                   $sql_gallery   = "SELECT * FROM `tb_gallery`";
                   $res_gallery   = $con->query($sql_gallery);
                   ...
                   ?>
                    <tr>
                        <td><?=$index;?></td>
                        <td><img style="width: 50px;" src="../gallery_iamge/<?=$row['photo']?>" alt=""></td>
                        <td>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title text-dark" id="exampleModalLongTitle">Gallery</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
