        ...
        <div class="box-content-right">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <input type="submit" value="Insert" name="btn-signup" class="btn btn-outline-primary">
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="w-50 text-white mt-4" style="margin-left: 400px;">
                <table id="myTable" class="table w-100 text-white">
                    ...
                    <tbody>
                        <?php
                        $sql_signup   = "SELECT * FROM `tb_signup`";
                        $res_signup   = $con->query($sql_signup);
                        if ($res_signup->num_rows > 0) {
                            $index = 1;
                            while ($row  = $res_signup->fetch_assoc()) {
                        ...
                        ?>
                                ...
                                <div class="modal fade" id="updateModel<?= $row['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title text-dark" id="exampleModalLongTitle">Update Sign Up</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <div class="modal-body text-dark">
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="">title detail</label>
                                                            <input type="text" name="txt_title_detail" class="form-control" value="<?= $row['detail'] ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="submit" value="No" class="btn btn-outline-danger">
                                                            <input type="submit" value="Update" name="btn_update_signup" class="btn btn-outline-success">
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                ...
                                <div class="modal fade" id="deleteModel<?= $row['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title text-dark" id="exampleModalLongTitle">Delete Signup</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <div class="modal-body text-dark">
                                                <form action="" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="submit" value="Delete" name="btn_signup_delete" class="btn btn-outline-danger">
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
